...
if roleArn == 'None':
    ...
    sdb = boto.sdb.connect_to_region('us-east-1', aws_access_key_id=assumed.credentials.access_key, aws_secret_access_keyassumed.credentials.secret_key, security_token=assumed.credentials.session_token)
...
# c1 medium
put_record("PriamProperties", "priam.heap.size.c1.medium", "512M")
put_record("PriamProperties", "priam.heap.newgen.size.c1.medium", "128M")
put_record("PriamProperties", "priam.direct.memory.size.c1.medium", "1G")
